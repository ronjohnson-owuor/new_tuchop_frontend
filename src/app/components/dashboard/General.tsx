  ...
  return (
	<div className="shadow-md p-4 dark:border dark:border-dSecondary">
		...
		<div id="div_scroll" className="w-[90%] p-2 flex flex-col gap-2 max-h-[300px] overflow-y-scroll">
			...
			<div className="flex flex-wrap gap-4 text-dText">
				<div className="flex flex-col bg-gradient-to-br from-primary to-accent p-2 rounded-md min-w-[150px] text-white">
